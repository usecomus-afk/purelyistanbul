...
export const SEED_LISTINGS: MarketplaceListing[] = [
  ...
  createRealListing({
    ...
    description: "İstanbul’un en popüler bohem semti Cihangir’de, Taksim ve Karaköy’e yürüme mesafesinde, tarihi dokuyu modern lüks tasarım mobilyalar ve yüksek tavan ferahlığıyla buluşturan seçkin daire.",
    category: 'konaklama',
    district: 'Cihangir, Beyoğlu',
    pricing: { basePrice: 4800, currency: 'TRY', cleaningFee: 450 },
    capacity: 4,
    amenities: ['Kısmi Boğaz Manzarası', 'Tarihi Tuğla Duvar', 'Yüksek Tavan', 'Hızlı Wi-Fi', 'Tam Donanımlı Mutfak', 'Klima'],
  ...
  createRealListing({
    ...
    description: "Maslak finans aksında, panoramik İstanbul şehir manzarasına hakim, akıllı ev otomasyonlu, konsiyerj hizmetli ultra modern rezidans dairesi.",
    category: 'konaklama',
    district: 'Maslak, Sarıyer',
    pricing: { basePrice: 6200, currency: 'TRY', cleaningFee: 600 },
    capacity: 4,
    amenities: ['Akıllı Ev Sistemi', '7/24 Güvenlik & Resepsiyon', 'Kapalı Havuz & Spa', 'Fitness & Sauna', 'Metro Bağlantısı'],
  ...
  createRealListing({
    id: 'seed-stay-3',
    type: 'stay',
    title: "Galata Kulesi Manzaralı Bohem Çatı Katı",
    description: "Galata Kulesi'ne yalnızca 50 metre mesafede, tarihi sokaklara ve kuleye bakan geniş özel terasıyla büyüleyici bir konaklama deneyimi.",
    category: 'konaklama',
    district: 'Galata, Beyoğlu',
    pricing: { basePrice: 5500, currency: 'TRY', cleaningFee: 500 },
    capacity: 3,
    amenities: ['Galata Kulesi Manzarası', 'Geniş Özel Teras', 'Tarihi Şömine', 'Espresso Makinesi', 'Klima'],
  ...
  createRealListing({
    id: 'seed-stay-4',
    type: 'stay',
    title: "Bebek Sahilinde Boğaz Manzaralı Lüks Yalı Dairesi",
    description: "İstanbul Boğazı'nın en zarif semti Bebek'te, denize sıfır konumda, sabah dalga sesleriyle uyanacağınız eşsiz bir yalı dairesi.",
    category: 'konaklama',
    district: 'Bebek, Beşiktaş',
    pricing: { basePrice: 9500, currency: 'TRY', cleaningFee: 800 },
    capacity: 5,
    amenities: ['Kesintisiz Boğaz Manzarası', 'Özel Balkon', 'Tasarım Mutfak', 'Şarap Soğutucu', 'Vale & Otopark'],
    coverImageUrl: 'https://images.unsplash.com/photo-1613490493576-7fde63acd811?auto=format&fit=crop&w=1200&q=80',
    galleryUrls: [
  ...
  createRealListing({
    id: 'seed-stay-5',
    type: 'stay',
    title: "Sultanahmet Tarihi Konak Deluxe Süit",
    description: "Tarihi yarımadanın merkezinde, Sultanahmet Camii ve Ayasofya'ya komşu, restore edilmiş Osmanlı konağında ayrıcalıklı süit.",
    category: 'konaklama',
    district: 'Sultanahmet, Fatih',
    pricing: { basePrice: 3800, currency: 'TRY', cleaningFee: 350 },
    capacity: 2,
    amenities: ['Tarihi Doku', 'Jakuzili Banyo', "Ayasofya'ya 3 Dakika", 'Oda Kahvaltı İmkânı', 'Hızlı Wi-Fi'],
  ...
  createRealListing({
    id: 'seed-stay-6',
    type: 'stay',
    title: "Moda Sahili Tasarım Loft & Balkon",
    description: "Kadıköy Moda'nın sakin ve ağaçlı sokaklarında, sahil yürüyüş yoluna ve en gözde kafelere bir adım mesafede aydınlık çatı katı loftu.",
    category: 'konaklama',
    district: 'Moda, Kadıköy',
    pricing: { basePrice: 4200, currency: 'TRY', cleaningFee: 400 },
    capacity: 3,
    amenities: ['Marmara Denizi Manzarası', 'Balkon', 'Çalışma Alanı', 'Nespresso Makinesi', 'Ses Yalıtımı'],
